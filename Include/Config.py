...
#        import RRScheduler
#        self.SCHEDULER = RRScheduler.RRScheduler
        #----------------------------
        ...
        #----------------------------
        ## Linux Scheduler
#        import LinuxScheduler
#        self.SCHEDULER = LinuxScheduler.LinuxScheduler
        #----------------------------
...
#        self.TIME_INCREMET = 200 #HZ
        self.TIME_INCREMET = 100 #HZ
        
        # the worst case task will cost
        # todo: not used
        self.WORST_CASE_EXECUTE_TIME = 2000 #HZ
...
#        ((init_cpu), proportion),
        ...
        # a new process has INIT_TASK_JIFFIES
        self.INIT_TASK_JIFFIES = 200 # HZ
        
        #-------------------------
        ## 默认的时间片基频数
        self.INIT_TIME_COUNTER_JIFFIES = 200 # HZ
        # used for 
...
#        (task_type, proportion),
        ...
        # a new process has INIT_TASK_JIFFIES millisecond
        assert self.INIT_TASK_JIFFIES > 0 # HZ
        
        # a new process has INIT_TIME_COUNTER_JIFFIES
        assert self.INIT_TIME_COUNTER_JIFFIES > 0 # HZ
